...
@section('title', 'Parameter Barang')
@section('content')
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                    ...
                    <div class="col">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="text-dark">Parameter</a></li>
                ...
                <a href="{{ route('barang.detail', $barang->id) }}" class="btn btn-sm btn-secondary mb-3">
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 'success') {
                        ...
                        setTimeout(function() {
                            window.top.location = "{{ route('barang.detail', $barang->id) }}"
                        }, 1500);
                    } else {
